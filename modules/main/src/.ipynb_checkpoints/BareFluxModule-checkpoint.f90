...
!  REAL :: WSPD
  ...
  SUBROUTINE SFCDIF1 (domain, levels, options, parameters, forcing, energy, water)
    IMPLICIT NONE
...
! friction velocity
  ...
  SUBROUTINE SFCDIF2 (domain, levels, options, parameters, forcing, energy, water)
    IMPLICIT NONE
...
! ----------------------------------------------------------------------
  ...
  SUBROUTINE ESAT (domain, levels, options, parameters, forcing, energy, water)
    IMPLICIT NONE

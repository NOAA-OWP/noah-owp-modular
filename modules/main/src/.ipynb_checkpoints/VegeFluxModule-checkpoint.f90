...
! also calls [ESAT, SFCDIF1, SFCDIF2] in BareFluxModule currently
...
!         Q2V = (EAH*0.622/(SFCPRS - 0.378*EAH))- QFX/(RHOAIR*FV)* 1./VKC * LOG((2.+Z0H)/Z0H)
  ...
  SUBROUTINE RAGRB (domain, levels, options, parameters, forcing, energy, water)
    IMPLICIT NONE
...
!       RB = 200
  ...
  SUBROUTINE STOMATA (domain, levels, options, parameters, forcing, energy, water)
    IMPLICIT NONE
...
!== begin canres ===================================================================================
  ...
  SUBROUTINE CANRES (domain, levels, options, parameters, forcing, energy, water)
    IMPLICIT NONE

...
end type parametersNML

contains

  subroutine readNamelist(this, inNML)

    class(parametersNML)            :: this
    character(len=256),  intent(in) :: inNML
...
!---------------------------------------------------------------------
    ...
    open(30, file=trim(inNML), form="formatted")

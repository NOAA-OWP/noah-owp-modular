...
program datetime_test
  ...
  type(declin_case), parameter :: declin_cases(*) = [ &
     ...
     , declin_case("julian is 0-based: Jan 1 00Z -> 0.0",  .true.,  2024,   1,   1,   0,   0,   0,  40.0,  -105.0,    0.0,      0.0,  -0.069061,    -0.069061,       366,    0.000000,  1.0e-4) &
  ...
  type(composed_case), parameter :: composed_cases(*) = [ &
     ...
     , composed_case("3600 non-leap, Feb28 +2 days ",  .true.,  3600,   2,  28,   0,   0,      2880,  40.0,  -105.0,    0.0,      0.0,  0.109952,     0.109952,       365,   60.000000,  1.0e-4) &
     , composed_case("3600 non-leap, Mar01 +1 days ",  .true.,  3600,   3,  01,   0,   0,      1440,  40.0,  -105.0,    0.0,      0.0,  0.109952,     0.109952,       365,   60.000000,  1.0e-4) &
     ]

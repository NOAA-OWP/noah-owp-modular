...
ncatt_put(nc=nc, varid=0, attname='dx', attval=1) # hardcode 1km NWM value (need to verify units)
ncatt_put(nc=nc, varid=0, attname='dy', attval=1) # hardcode 1km NWM value (need to verify units)

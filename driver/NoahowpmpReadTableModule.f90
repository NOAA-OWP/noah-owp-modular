...
CONTAINS
  ...
  SUBROUTINE read_all_parameters(NoahowpmpIO)
    
    type(NoahmpIO_type), intent(inout) :: NoahowpmpIO

    call read_soil_parameters(NoahowpmpIO%parameter_dir, NoahowpmpIO%soil_table, NoahowpmpIO%general_table, NoahowpmpIO%soil_class_name)
    call read_veg_parameters(NoahowpmpIO%parameter_dir, NoahowpmpIO%noahowp_table, NoahowpmpIO%veg_class_name)
    call read_rad_parameters(NoahowpmpIO%parameter_dir, NoahowpmpIO%noahowp_table)
    call read_global_parameters(NoahowpmpIO%parameter_dir, NoahowpmpIO%noahowp_table)

...
subroutine add_to_output(domain, water, energy, forcing, itime, nsoil, nsnow)
  ...
  iret = nf90_put_var(ncid,  smc_id,    water%smc,                   start=(/ix,iy,itime,1/), count=(/1,nsoil/))
  ! for canopy water
  ...
  iret = nf90_put_var(ncid, snice_id,   water%snice,                start=(/ix,iy,itime,1/), count=(/1,nsnow/))
  iret = nf90_put_var(ncid, snliq_id,   water%snliq,                start=(/ix,iy,itime,1/), count=(/1,nsnow/))
  iret = nf90_put_var(ncid, stc_id,     energy%stc,                 start=(/ix,iy,itime,1/), count=(/1,nsoil+nsnow/))
  iret = nf90_put_var(ncid, zsnso_id,   zsnso,                      start=(/ix,iy,itime,1/), count=(/1,nsoil+nsnow/))
  ! energy

...
subroutine add_to_output(domain, water, energy, forcing, itime, nsoil, nsnow)
  ...
  iret = nf90_put_var(ncid, prcp_id,    forcing%prcp*dt,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qinsur_id,  water%qinsur*1000*dt,        start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, sfrn_id,    water%runsrf*dt,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, ugrn_id,    water%runsub*dt,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, evap_id,    water%qseva*1000.0*dt,       start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, tran_id,    sum(water%etrani)*1000.0*dt, start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, evapotrans_id, water%evapotrans*1000.0*dt, start=(/ix,iy,itime/))
  !iret = nf90_put_var(ncid, smcm_id,    smcmm,       start=(/itime+1,1/), count=(/1,nsoil/))
  iret = nf90_put_var(ncid,  smc_id,    water%smc,                   start=(/ix,iy,itime,1/), count=(/1,1,1,nsoil/))
  ! for canopy water
  iret = nf90_put_var(ncid, qintr_id,   water%qintr*dt,              start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qints_id,   water%qints*dt,              start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qdripr_id,  water%qdripr*dt,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qdrips_id,  water%qdrips*dt,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qthror_id,  water%qthror*dt,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qthros_id,  water%qthros*dt,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qrain_id,   water%qrain*dt,              start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qsnow_id,   water%qsnow*dt,              start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, snowhin_id, water%snowhin*dt,            start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, fwet_id,    water%fwet,                  start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, cmc_id,     water%cmc,                   start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, canliq_id,  water%canliq,                start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, canice_id,  water%canice,                start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, ecan_id,    water%ecan*dt,               start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, etran_id,   water%etran*dt,              start=(/ix,iy,itime/))
  ! for snow water
  iret = nf90_put_var(ncid, snowh_id,   water%snowh,                start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, sneqv_id,   water%sneqv,                start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, ponding_id, water%ponding,              start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, ponding1_id,water%ponding1,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, ponding2_id,water%ponding2,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qsnbot_id,  water%qsnbot*dt,            start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qsnfro_id,  water%qsnfro*dt,            start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, qsnsub_id,  water%qsnsub*dt,            start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, snice_id,   water%snice,                start=(/ix,iy,itime,1/), count=(/1,1,1,nsnow/))
  iret = nf90_put_var(ncid, snliq_id,   water%snliq,                start=(/ix,iy,itime,1/), count=(/1,1,1,nsnow/))
  iret = nf90_put_var(ncid, stc_id,     energy%stc,                 start=(/ix,iy,itime,1/), count=(/1,1,1,nsoil+nsnow/))
  iret = nf90_put_var(ncid, zsnso_id,   zsnso,                      start=(/ix,iy,itime,1/), count=(/1,1,1,nsoil+nsnow/))
  ! energy
  iret = nf90_put_var(ncid, swin_id,    forcing%SWDOWN,             start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, lh_id,      energy%lh,                  start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, t2m_id,     energy%t2m,                 start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, t2mb_id,    energy%t2mb,                start=(/ix,iy,itime/))
  iret = nf90_put_var(ncid, t2mv_id,    energy%t2mv,                start=(/ix,iy,itime/))

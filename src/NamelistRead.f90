...
type, public :: namelist_type
  ...
  character(len=256) :: mpt_table          ! name of noahmp-style parameter table (e.g., 'MPTABLE.TBL')
  character(len=256) :: soil_table         ! name of soil parameter table (e.g., 'SOILPARM.TBL')
  character(len=256) :: general_table      ! name of general parameter table (e.g., 'GENPARM.TBL')
...
contains
  ...
  subroutine ReadNamelist(this, namelist_file)
    ...
    namelist / parameters      / parameter_dir, soil_table, general_table, mpt_table, soil_class_name, veg_class_name
